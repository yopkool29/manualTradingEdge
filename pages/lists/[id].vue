  ...
  <div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
      <div class="flex items-center space-x-4">
        <button
          @click="router.push('/')"
          class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-md flex items-center"
        >
    ...
    <div v-if="list" class="bg-white rounded-lg shadow-md p-6">
      <div class="mb-6">
        <input
          v-model="list.title"
          @blur="updateList"
          class="text-2xl font-bold w-full mb-2 px-2 py-1 border rounded focus:outline-none focus:border-blue-500"
        />
        <textarea
          v-model="list.comment"
          @blur="updateList"
          class="w-full px-2 py-1 border rounded focus:outline-none focus:border-blue-500 text-gray-600"
          rows="2"
        ></textarea>
